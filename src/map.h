...
#define map_set(map, key, val)  (typeof(map))(_map_set(&map MAP_DEBUG_INFO, sizeof(*map), (void *)key, sizeof(key), val))
#define map_once(map, key, val) (typeof(map))(_map_once(&map MAP_DEBUG_INFO, sizeof(*map), (void *)key, sizeof(key), val))
